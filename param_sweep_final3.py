"""Final-final sweep: DMIN=0.30 combinations."""
...
combos = [
    ("BASELINE", {}),
    ("J2+S90+D200+DMIN=0.30", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.30"}),
    ("...+BD=0.020", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.30", "PAPER_MIN_BOUNDARY_DIST_PCT": "0.020"}),
    ("...+BD=0.020+EDGE=0.08", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.30", "PAPER_MIN_BOUNDARY_DIST_PCT": "0.020", "MIN_EDGE": "0.08"}),
    ("...+BD=0.020+ROI=0.03", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.30", "PAPER_MIN_BOUNDARY_DIST_PCT": "0.020", "MIN_EXPECTED_ROI": "0.03", "PAPER_MIN_EXPECTED_ROI": "0.03"}),
    ("DMIN=0.30+DEND=220", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.30", "PAPER_DOWN_ENTRY_END_SEC": "220"}),
    ("DMIN=0.30+DEND=220+BD=0.020", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.30", "PAPER_DOWN_ENTRY_END_SEC": "220", "PAPER_MIN_BOUNDARY_DIST_PCT": "0.020"}),
    ("DMIN=0.28", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.28"}),
    ("DMIN=0.33", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.33"}),
    # Conservative best: DMIN=0.35+BD=0.020 (good PF, lower risk)
    ("SAFE: DMIN=0.35+BD=0.020", {**BASE, "PAPER_DOWN_MIN_ENTRY_PRICE": "0.35", "PAPER_MIN_BOUNDARY_DIST_PCT": "0.020"}),
]

print(f"\n{'='*105}")
print(f"  FINAL SWEEP: DMIN variations on JURY=2, START=90, DEND=200")
print(f"{'='*105}")
