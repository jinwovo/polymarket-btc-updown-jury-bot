...
- `LIVE_PROFIT_MODE` (`AGGRESSIVE` | `BALANCED`)
- `LIVE_AGGRESSIVE_ENTRY_RELAX`, `LIVE_AGGRESSIVE_MIN_EDGE_RELAX`, `LIVE_AGGRESSIVE_SUPPORT_RELAX`
- `LIVE_AGGRESSIVE_MAX_FRAC`, `LIVE_AGGRESSIVE_KELLY_FRAC`, `LIVE_AGGRESSIVE_LOSS_DEBOOST`
...
- `PAPER_PROFIT_MODE` (`aggressive` | `balanced`)
- `PAPER_AGGRESSIVE_ENTRY_RELAX`, `PAPER_AGGRESSIVE_GAP_MULT`
- `PAPER_AGGRESSIVE_MAX_BET_FRAC`, `PAPER_AGGRESSIVE_KELLY_FRAC`, `PAPER_AGGRESSIVE_LOSS_DEBOOST`
...
- `PAPER_EARLY_EXIT_STOP_LOSS_REQUIRE_BTC_ADVERSE`, `PAPER_EARLY_EXIT_STOP_LOSS_BTC_ADVERSE_PCT`
